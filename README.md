...
## TL;DR
- **What it is:** Options Insight is an automated tool that gives retail options traders the edge they need. It analyzes upcoming company earnings, enriches the data with volatility and sentiment analysis, and delivers a powerful, easy-to-read newsletter to your inbox every morning.
